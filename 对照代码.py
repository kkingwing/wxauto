...
print(msgs[:-1])
print([i[-1] for i in msgs[:-1]])
print([i[-2] for i in msgs[:-1]])
# 合并文本
merge_msgs = "".join([i[-2] for i in msgs[:-1]])
print('' in merge_msgs)

print([i[-1] for i in msgs].index('422000424292'))



groups = ['gpt测试群', "小红书运营交流群18"]
