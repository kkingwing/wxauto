...
__all__ = [
    ...
    'UIA_BoundingRectanglePropertyId', 'UIA_ClickablePointPropertyId',
    'RowOrColumnMajor_ColumnMajor', 'StyleId_Subtitle',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_IsContentElementPropertyId', 'AutomationElementMode',
    'UIA_MenuModeStartEventId', 'UIA_AccessKeyPropertyId',
    'UIA_ProviderDescriptionPropertyId', 'UIA_NamePropertyId',
    'TreeScope_Parent', 'AnnotationType_FormatChange', 'ToggleState',
    'IUIAutomationEventHandlerGroup', 'UIA_ItemTypePropertyId',
    'OrientationType_Horizontal', 'ExpandCollapseState_Expanded',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_LocalizedControlTypePropertyId', 'ProviderOptions',
    'UIA_ScrollItemPatternId', 'IUIAutomationTextPattern',
    'UIA_RangeValueValuePropertyId', 'UIA_AsyncContentLoadedEventId',
    'StructureChangeType_ChildrenBulkRemoved',
    'ProviderOptions_UseComThreading',
    'UIA_GridColumnCountPropertyId', 'AnnotationType_Unknown',
    'DockPosition_Fill', 'UIA_LegacyIAccessibleHelpPropertyId',
    'IUIAutomationTableItemPattern', 'UIA_StylesStyleIdPropertyId',
    ...
    'UIA_TreeControlTypeId', 'AnnotationType_MoveChange',
    'UIA_ButtonControlTypeId', 'UIA_SizePropertyId',
    'IUIAutomationWindowPattern', 'UIA_AriaRolePropertyId',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_SplitButtonControlTypeId', 'UIA_StylesPatternId',
    'UIA_TextPattern2Id', 'NotificationKind_Other',
    'IUIAutomationItemContainerPattern', 'TreeScope_Children',
    'CUIAutomation8', 'UIA_ObjectModelPatternId',
    'WindowInteractionState', 'HeadingLevel1',
    'ExpandCollapseState_LeafNode',
    'UIA_TransformCanResizePropertyId',
    'AnnotationType_ExternalChange', 'UIA_AnnotationTypesAttributeId',
    'UIA_StyleIdAttributeId', 'AnnotationType_Header',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'AnnotationType_ConflictingChange', 'IUIAutomationTogglePattern',
    'IUIAutomationProxyFactoryEntry',
    'NotificationProcessing_ImportantAll',
    'UIA_TitleBarControlTypeId', 'RowOrColumnMajor_Indeterminate',
    'AnnotationType_Highlighted', 'ZoomUnit_NoAmount',
    'IUIAutomationTextRange', 'UIA_AnnotationDateTimePropertyId',
    'IUIAutomationExpandCollapsePattern', 'IUIAutomationAndCondition',
    'OrientationType_Vertical', 'IUIAutomationSelectionPattern',
    'UIA_SummaryChangeId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'AnnotationType_DeletionChange', 'UIA_DragIsGrabbedPropertyId',
    'UIA_AnnotationObjectsPropertyId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_ThumbControlTypeId', 'UIA_AfterParagraphSpacingAttributeId',
    'AnnotationType_GrammarError', 'AnnotationType_Mathematics',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'NavigateDirection_FirstChild', 'UIA_StructureChangedEventId',
    'UIA_IsInvokePatternAvailablePropertyId', 'TextUnit_Format',
    'CoalesceEventsOptions_Enabled', 'StyleId_Heading2',
    'UIA_FlowsToPropertyId', 'UIA_Window_WindowOpenedEventId',
    'OrientationType', 'UIA_ToolBarControlTypeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'ProviderOptions_ClientSideProvider', 'ToggleState_Off',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_DropTarget_DragLeaveEventId',
    'NotificationKind_ActionCompleted',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_CustomLandmarkTypeId', 'UIA_IndentationTrailingAttributeId',
    'UIA_ComboBoxControlTypeId',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'ZoomUnit_LargeIncrement', 'ScrollAmount',
    'UIA_MenuBarControlTypeId', 'IUIAutomationEventHandler',
    'UIA_CustomControlTypeId', 'UIA_GridItemPatternId',
    'AnnotationType_Endnote', 'AnnotationType_UnsyncedChange',
    'UIA_DropTarget_DragEnterEventId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'StructureChangeType_ChildrenReordered',
    'UIA_AnimationStyleAttributeId', 'UIA_DragDropEffectPropertyId',
    'StyleId_Heading3', 'NavigateDirection', 'UIA_TableControlTypeId',
    'ZoomUnit', 'UIA_SayAsInterpretAsMetadataId',
    'IUIAutomationChangesEventHandler',
    'TreeTraversalOptions_PostOrder',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'StructureChangeType_ChildrenInvalidated',
    'IUIAutomationElementArray', 'UIA_CulturePropertyId',
    'TreeTraversalOptions', 'UIA_TextControlTypeId',
    'UIA_InvokePatternId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_HeadingLevelPropertyId', 'UIA_CheckBoxControlTypeId',
    'IUIAutomationGridItemPattern', 'ZoomUnit_LargeDecrement',
    'SupportedTextSelection_Single', 'DockPosition_Bottom',
    'UIA_GridPatternId', 'UIA_ItemStatusPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_LandmarkTypePropertyId', 'UIA_RotationPropertyId',
    'StructureChangeType_ChildRemoved', 'DockPosition_Right',
    'DockPosition', 'IUIAutomationTablePattern',
    'AnnotationType_Sensitive', 'UIA_IsRequiredForFormPropertyId',
    'UIA_AppBarControlTypeId',
    'IUIAutomationLegacyIAccessiblePattern',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'TextEditChangeType_AutoCorrect', 'UIA_SystemAlertEventId',
    'ProviderOptions_OverrideProvider', 'WindowVisualState_Normal',
    'StyleId_Heading7', 'UIA_NavigationLandmarkTypeId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_Window_WindowClosedEventId', 'UIA_WindowIsModalPropertyId',
    'IUIAutomationTextChildPattern', 'IUIAutomationPropertyCondition',
    'UIA_PaneControlTypeId', 'IUIAutomation2', 'UIA_TabsAttributeId',
    'UIA_LevelPropertyId', 'UIA_MenuOpenedEventId',
    'UIA_FillColorPropertyId', 'UIA_CultureAttributeId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'RowOrColumnMajor_RowMajor', 'IUIAutomation5',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'WindowVisualState_Minimized', 'UIA_GridItemRowPropertyId',
    'UIA_GridItemRowSpanPropertyId', 'UIA_AnnotationTypesPropertyId',
    'UIA_WindowIsTopmostPropertyId', 'UIA_TabControlTypeId',
    'IRawElementProviderSimple', 'TextUnit_Paragraph',
    'HeadingLevel3', 'UIA_AcceleratorKeyPropertyId',
    'StructureChangeType_ChildAdded',
    'UIA_AnnotationTargetPropertyId', 'ExpandCollapseState',
    'HeadingLevel4', 'UIA_SynchronizedInputPatternId',
    'UIA_TablePatternId', 'UIA_ProcessIdPropertyId',
    'UIA_HeaderItemControlTypeId', 'UIA_AnnotationObjectsAttributeId',
    'ExpandCollapseState_Collapsed', 'UIA_OverlineStyleAttributeId',
    'IUIAutomationTextRange2', 'TextUnit_Character',
    'UIA_HeaderControlTypeId', 'NotificationKind',
    'UIA_RuntimeIdPropertyId', 'IUIAutomationTransformPattern',
    'TreeScope_Subtree', 'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_SelectionPattern2Id', 'IUIAutomationDropTargetPattern',
    'UIA_Invoke_InvokedEventId', 'SynchronizedInputType_KeyUp',
    'UIA_SpinnerControlTypeId', 'WindowInteractionState_Closing',
    'IUIAutomationMultipleViewPattern', 'StyleId_Heading6',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_BulletStyleAttributeId', 'UIA_ValuePatternId',
    'TreeScope_Element', 'UIA_SelectionActiveEndAttributeId',
    'RowOrColumnMajor', 'UIA_Drag_DragStartEventId',
    'UIA_GroupControlTypeId', 'UIA_WindowPatternId',
    'ScrollAmount_LargeDecrement', 'UIA_MarginBottomAttributeId',
    'AnnotationType_TrackChanges', 'IUIAutomationProxyFactoryMapping',
    'UIA_TableRowHeadersPropertyId', 'TreeScope',
    'UIA_GridRowCountPropertyId', 'ToggleState_Indeterminate',
    'IUIAutomationBoolCondition',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_ListItemControlTypeId', 'UIA_IsSubscriptAttributeId',
    'UIA_ScrollBarControlTypeId', 'WindowInteractionState_Running',
    'UIA_TransformPattern2Id', 'UIA_DockPatternId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_SpreadsheetPatternId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'IUIAutomationFocusChangedEventHandler', 'UiaChangeInfo',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_ExpandCollapsePatternId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_TableItemPatternId',
    'IUIAutomationStructureChangedEventHandler',
    'StyleId_BulletedList', 'NavigateDirection_NextSibling',
    'SynchronizedInputType', 'TextUnit_Document',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_IsEnabledPropertyId', 'UIA_Transform2ZoomLevelPropertyId',
    'ToggleState_On', 'IUIAutomationProxyFactory',
    'UIA_FontSizeAttributeId', 'HeadingLevel_None',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'AnnotationType_FormulaError', 'UIA_FullDescriptionPropertyId',
    'AnnotationType_SpellingError', 'IUIAutomationScrollPattern',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_TabItemControlTypeId', 'IUIAutomationTextEditPattern',
    'IUIAutomation6', 'CoalesceEventsOptions',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_OutlineStylesAttributeId',
    'UIA_LocalizedLandmarkTypePropertyId', 'UIA_MenuControlTypeId',
    'SynchronizedInputType_RightMouseUp', 'UIA_MarginTopAttributeId',
    'DockPosition_Left',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'TextPatternRangeEndpoint', 'UIA_RadioButtonControlTypeId',
    'UIA_TransformPatternId', 'IUIAutomationElement6',
    'ScrollAmount_LargeIncrement', 'IUIAutomation', 'TextUnit_Line',
    'UIA_InputDiscardedEventId', 'UIA_ClassNamePropertyId',
    'AutomationElementMode_None', 'IUIAutomationSelectionItemPattern',
    'UIA_ChangesEventId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_OptimizeForVisualContentPropertyId', 'TreeScope_None',
    'UIA_CaretBidiModeAttributeId', 'UIA_IsPeripheralPropertyId',
    'WindowVisualState', 'StructureChangeType',
    'UIA_MenuClosedEventId', 'UIA_LiveSettingPropertyId',
    'StyleId_Title', 'UIA_ToolTipClosedEventId',
    'AnnotationType_InsertionChange', 'TreeTraversalOptions_Default',
    ...
    'UIA_Selection_InvalidatedEventId', 'UIA_TextPatternId', 'Polite',
    'UIA_LinkAttributeId', 'AnnotationType_DataValidationError',
    'PropertyConditionFlags_None', 'IUIAutomationElement2',
    'UIA_SelectionSelectionPropertyId', 'IUIAutomationDragPattern',
    'UIA_IsDataValidForFormPropertyId',
    'UIA_AnnotationAuthorPropertyId', 'UIA_CapStyleAttributeId',
    'PropertyConditionFlags', 'UIA_Transform2CanZoomPropertyId',
    'HeadingLevel8', 'LiveSetting', 'SupportedTextSelection',
    'UIA_PositionInSetPropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_VirtualizedItemPatternId', 'UIA_LabeledByPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_ProgressBarControlTypeId', 'UIA_SeparatorControlTypeId',
    'StyleId_Heading4', 'ConnectionRecoveryBehaviorOptions',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_FrameworkIdPropertyId', 'IUIAutomationDockPattern',
    'UIA_LegacyIAccessibleValuePropertyId', 'UIA_MainLandmarkTypeId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_MarginLeadingAttributeId', 'OrientationType_None',
    'IUIAutomationTextRange3', 'UIA_RangeValueSmallChangePropertyId',
    ...
    'TextEditChangeType_None', 'UIA_IsPasswordPropertyId',
    'UIA_GridItemColumnPropertyId', 'IUIAutomationRangeValuePattern',
    'SynchronizedInputType_LeftMouseDown', 'DockPosition_None',
    'UIA_LineSpacingAttributeId', 'UIA_ValueValuePropertyId',
    'UIA_SliderControlTypeId', 'WindowVisualState_Maximized',
    'UIA_ForegroundColorAttributeId', 'UIA_MenuModeEndEventId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'TreeScope_Descendants', 'IUIAutomationSpreadsheetPattern',
    'UIA_BackgroundColorAttributeId', 'IUIAutomationTextPattern2',
    'TextPatternRangeEndpoint_End', 'SynchronizedInputType_KeyDown',
    'ExtendedProperty', 'ExpandCollapseState_PartiallyExpanded',
    'AutomationElementMode_Full', 'UIA_SayAsInterpretAsAttributeId',
    'UIA_IsDockPatternAvailablePropertyId', 'DockPosition_Top',
    'SynchronizedInputType_LeftMouseUp', 'UIA_HelpTextPropertyId',
    ...
    'TextUnit', 'UIA_GridItemContainingGridPropertyId',
    'UIA_DataItemControlTypeId', 'UIA_DataGridControlTypeId',
    'ScrollAmount_SmallDecrement', 'UIA_MultipleViewPatternId',
    'UIA_IsTransformPatternAvailablePropertyId', 'StyleId_Heading9',
    'UIA_ScrollPatternId', 'AnnotationType_EditingLockedChange',
    'UIA_ValueIsReadOnlyPropertyId',
    'UIA_WindowCanMinimizePropertyId', 'IUIAutomationInvokePattern',
    'UIA_SelectionItemPatternId', 'UIA_IsSuperscriptAttributeId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_IsReadOnlyAttributeId', 'NotificationKind_ActionAborted',
    'WindowInteractionState_NotResponding',
    'IUIAutomationValuePattern', 'UIA_IsKeyboardFocusablePropertyId',
    'UIA_StylesShapePropertyId', 'UIA_FormLandmarkTypeId',
    'UIA_DragGrabbedItemsPropertyId',
    'IUIAutomationScrollItemPattern', 'IUIAutomationNotCondition',
    'UIA_StylesStyleNamePropertyId', 'UIA_FillTypePropertyId',
    'UIA_TogglePatternId', 'UIA_MenuItemControlTypeId',
    'TextPatternRangeEndpoint_Start', 'IUIAutomation4',
    'UIA_Drag_DragCancelEventId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_NotificationEventId', 'NavigateDirection_PreviousSibling',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_LiveRegionChangedEventId',
    'ProviderOptions_NonClientAreaProvider', 'HeadingLevel7',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'StyleId_Custom', 'UIA_FontNameAttributeId',
    'UIA_CenterPointPropertyId', 'UIA_ListControlTypeId',
    'IUIAutomationNotificationEventHandler',
    'UIA_ControllerForPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_IsControlElementPropertyId', 'AnnotationType_Footnote',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_Drag_DragCompleteEventId',
    'AnnotationType_AdvancedProofingIssue', 'IUIAutomation3',
    'UIA_TransformCanMovePropertyId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'IUIAutomationGridPattern', 'HeadingLevel6', 'TextUnit_Page',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'IUIAutomationSelectionPattern2', 'UIA_UnderlineColorAttributeId',
    'CUIAutomation', 'HeadingLevel9', 'NotificationProcessing_All',
    'UIA_SpreadsheetItemPatternId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_LegacyIAccessiblePatternId', 'TextEditChangeType',
    'TextEditChangeType_Composition',
    'IUIAutomationObjectModelPattern', 'NotificationProcessing',
    'UIA_StrikethroughStyleAttributeId', 'IUIAutomationCacheRequest',
    'ZoomUnit_SmallDecrement', 'IUIAutomationTreeWalker',
    'ScrollAmount_SmallIncrement',
    'UIA_Selection2LastSelectedItemPropertyId',
    'IUIAutomationElement8', 'StyleId_Heading5',
    'IUIAutomationElement5', 'UIA_DropTargetPatternId',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_FontWeightAttributeId', 'UIA_Selection2ItemCountPropertyId',
    'NotificationKind_ItemAdded', 'UIA_ToolTipControlTypeId',
    'UIA_VisualEffectsPropertyId', 'UIA_HasKeyboardFocusPropertyId',
    'IUIAutomationElement4', 'UIA_IsValuePatternAvailablePropertyId',
    'UIA_OverlineColorAttributeId', 'UIA_RangeValuePatternId', 'Off',
    'TreeScope_Ancestors', 'StyleId_Emphasis',
    'UIA_DocumentControlTypeId', 'SupportedTextSelection_None',
    'UIA_ActiveTextPositionChangedEventId', 'IUIAutomationElement7',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_DragPatternId', 'Assertive', 'UIA_IsActiveAttributeId',
    ...
    'UIA_InputReachedOtherElementEventId', 'IUIAutomationElement3',
    'ProviderOptions_ServerSideProvider',
    'UIA_UnderlineStyleAttributeId',
    'UIA_RangeValueMinimumPropertyId', 'IAccessible',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_StyleNameAttributeId', 'UIA_TextChildPatternId',
    'UIA_DragDropEffectsPropertyId', 'UIA_DockDockPositionPropertyId',
    'UIA_CalendarControlTypeId', 'StyleId_NumberedList',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_FlowsFromPropertyId',
    'UIA_IsItalicAttributeId', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_OrientationPropertyId',
    'UIA_IsDragPatternAvailablePropertyId', 'StyleId_Heading1',
    'UIA_ScrollVerticalViewSizePropertyId', 'UIA_IsHiddenAttributeId',
    'UIA_RangeValueMaximumPropertyId', 'IUIAutomationStylesPattern',
    'SynchronizedInputType_RightMouseDown',
    'UIA_DescribedByPropertyId', 'UIA_StylesFillColorPropertyId',
    'UIA_StrikethroughColorAttributeId', 'ScrollAmount_NoAmount',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_WindowControlTypeId', 'NotificationKind_ItemRemoved',
    'UIA_IsDialogPropertyId', 'HeadingLevel2',
    'UIA_ToolTipOpenedEventId', 'UIA_LayoutInvalidatedEventId',
    'PropertyConditionFlags_IgnoreCase',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_AutomationPropertyChangedEventId', 'StyleId_Quote',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_CustomNavigationPatternId', 'UIA_SizeOfSetPropertyId',
    'UIA_EditControlTypeId', 'UIA_ImageControlTypeId',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_OutlineColorPropertyId', 'UIA_StatusBarControlTypeId',
    'NavigateDirection_Parent', 'ZoomUnit_SmallIncrement',
    ...
    'WindowInteractionState_BlockedByModalWindow', 'StyleId_Normal',
    'TextEditChangeType_AutoComplete', 'IUIAutomationElement',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_OutlineThicknessPropertyId',
    'UIA_IndentationLeadingAttributeId', 'AnnotationType_Footer',
    'IUIAutomationTextRangeArray', 'CoalesceEventsOptions_Disabled',
    'HeadingLevel5', 'UIA_TransformCanRotatePropertyId',
    'NotificationProcessing_MostRecent',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_SemanticZoomControlTypeId', 'UIA_SearchLandmarkTypeId',
    'UIA_AnnotationPatternId', 'IUIAutomationOrCondition',
    'IUIAutomationElement9', 'UIA_TreeItemControlTypeId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'StyleId_Heading8', 'UIA_AutomationFocusChangedEventId',
    'AnnotationType_Author', 'TextUnit_Word', 'UIA_TextEditPatternId'
]

_check_version('1.2.1', 1673068251.234961)
